...
# 🌸 Fragrantica Perfume Recommendation System

A content-based recommendation engine that suggests similar fragrances using scent accords, ratings, popularity metrics, and fragrance characteristics. Built with Python and machine learning techniques to help users discover perfumes that match their preferences.
